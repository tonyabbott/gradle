...
public class ModelInstanceSchema<T> extends ModelSchema<T> {
    private final ImmutableSortedMap<String, ModelProperty<?>> properties;

    public ModelInstanceSchema(ModelType<T> type, Kind kind, Iterable<? extends ModelProperty<?>> properties) {
        super(type, kind);
