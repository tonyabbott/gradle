...
public class ModelStructSchema<T> extends ModelInstanceSchema<T> {
    ...
    public ModelStructSchema(ModelType<T> type, Iterable<? extends ModelProperty<?>> properties, Class<? extends T> managedImpl, @Nullable Class<?> delegateType, Function<ModelStructSchema<T>, NodeInitializer> nodeInitializer) {
